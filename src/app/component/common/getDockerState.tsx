        ...
        <div className={styles.box}>
            ...
            {containers.map((c: DockerContainer) => (
                <div key={c.ID} className={styles.item}>
                    <span className={styles.bullet}>▶</span> {c.Names === 'mablog_proxy' ? 'proxy_container': c.Names === 'mablog_nextjs' ? 'server_container' : c.Names === 'mablog_mongodb'? 'data_container': 'security_container'}
